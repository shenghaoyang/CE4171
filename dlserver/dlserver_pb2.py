...
_INFERENCEREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="audio_samples",
            full_name="info.shenghaoyang.ntu.ntu_iot.dlserver.InferenceRequest.audio_samples",
            index=0,
            number=1,
            type=2,
            cpp_type=6,
...
_INFERENCERESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="label",
            full_name="info.shenghaoyang.ntu.ntu_iot.dlserver.InferenceResponse.label",
            index=0,
            number=1,
            type=14,
            cpp_type=8,
...
_TRAININGREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="label",
            full_name="info.shenghaoyang.ntu.ntu_iot.dlserver.TrainingRequest.label",
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="audio_samples",
            full_name="info.shenghaoyang.ntu.ntu_iot.dlserver.TrainingRequest.audio_samples",
            index=1,
            number=2,
            type=2,
            cpp_type=6,
...
TrainingRequest = _reflection.GeneratedProtocolMessageType(
    "TrainingRequest",
    (_message.Message,),
    {
