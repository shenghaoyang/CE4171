...
class DLServer(object):
    ...
    def Infer(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/info.shenghaoyang.ntu.ntu_iot.dlserver.DLServer/Infer',
    ...
    def Train(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/info.shenghaoyang.ntu.ntu_iot.dlserver.DLServer/Train',
